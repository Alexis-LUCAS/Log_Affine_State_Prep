...
* a Notebook simulating the state preparation of  $\frac{1}{\sqrt{2^{n}}} \sum\limits_{x \in B_n}{\left( 1-\frac{2 p_n x}{1- \frac{1}{2^n}}\right) \ket x}$  , entitled spue_simulation.ipynb,
